...
import 'login_screen.dart'; // Para LoginWrapper
import 'main.dart'; // PARA USAR LoginWrapper
...
class _SidebarState extends State<Sidebar> {
  ...
  String _selectedCategory = ''; // Agora vazio = mostra grid de categorias
          ...
          Container(
            ...
            child: Column(
              children: [
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.inventory_2_rounded, size: 28, color: Color(0xFFFF6B35)),
                      ),
                      SizedBox(width: 16),
                      Expanded(
                        child: Column(
                ...
                // CONFERENTE
                Padding(padding: EdgeInsets.fromLTRB(20, 20, 20, 16), child: _conferenteDropdown()),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Icons.copyright_rounded, size: 11, color: Colors.white.withOpacity(0.3)),
                          SizedBox(width: 4),
                          Text(
                            'Ao Gosto 2025',
                            style: GoogleFonts.inter(color: Colors.white.withOpacity(0.3), fontSize: 10, fontWeight: FontWeight.w500),
                          ),
                        ],
                      ),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        _selectedMain,
                        style: GoogleFonts.inter(fontSize: 24, fontWeight: FontWeight.w800, color: Color(0xFF212529)),
                      ),
                      Spacer(),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(gradient: LinearGradient(colors: [Color(0xFFFF6B35), Color(0xFFFF8C42)]), shape: BoxShape.circle),
                                child: Icon(Icons.person_rounded, size: 16, color: Colors.white),
                              ),
                              SizedBox(width: 10),
                              Text(
                                ApiService.conferenteNome!,
                                style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFFFF6B35)),
                              ),
                            ],
                          ),
                        ),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () {
            setState(() {
              _selectedMain = title;
              _selectedCategory = ''; // Reset para mostrar grid de categorias
            });
          },
          child: Padding(
        ...
        builder: (context, snapshot) {
          ...
          return DropdownButtonFormField<int>(
            ...
            onChanged: (id) => id != null
                ? ApiService.selecionarConferente(id, conferentes.firstWhere((c) => c['id'] == id)['nome'])
                : null,
          );
        },
      ),
  ...
  Widget _loadingDropdown() => Container(
        ...
        child: Center(child: CircularProgressIndicator(color: Color(0xFFFF6B35), strokeWidth: 2.5)),
      );
    ...
    return await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(
              ...
              style: GoogleFonts.inter(fontSize: 14, color: Color(0xFF6C757D), height: 1.5),
            ),
            actions: [
              TextButton(
                ...
                child: Text(
                  'Cancelar',
                  style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFF6C757D)),
                ),
              ),
              ElevatedButton(
